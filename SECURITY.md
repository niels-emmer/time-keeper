...
All application code was generated by AI — [Pi](https://pi.ai) (Inflection AI), [Claude Code](https://claude.ai/claude-code) (Anthropic), and GPT-5.4 (OpenAI) — directed and reviewed by the author. The code has **not been independently audited or pentested**. Treat it accordingly.
